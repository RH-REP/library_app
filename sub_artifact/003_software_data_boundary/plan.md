...
- [x] 開発段階では release の厳密性より main_artifact の物理分離を優先する方針へ更新する。
- [x] Web app 前提の main_artifact フォルダ構成案を作成する。
- [x] `main_artifact/web_app/` `main_artifact/private_data/` `main_artifact/fixtures/` の骨格を追加する。
...
- `main_artifact/web_app/` を単一 app と frontend/backend 分離のどちらで始めるか。
